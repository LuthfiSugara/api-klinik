                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 30px"> 
                            <p>Hi {{ $details['name'] }}</p>
                            <p>Anda baru saja mengirim permintaan perubahan password pada akun anda. Silahkan Klik/Tekan tombol <strong>Konfirmasi</strong> untuk merubah password anda.</p>
                            <div class="text-center">
                                <a href="{!! url('confirm-reset-password/'.$details['token']) !!}" style="padding: 10px; background-color: ##05ac10; color: #fff; display: inline-block; border-radius: 4px; margin-bottom: 18px">Konfirmasi </a>
                            </div>
                            <p>Jika anda merasa tidak melakukan tindakan ini, mohon abaikan email ini. Jika ada pertanyaan lebih lanjut mengenai <strong>Klinik Yazid Pratama</strong> Silahkan Hubungi Admin.</p>
                            <p style="margin-bottom: 0">Terima Kasih,</p>
                            <p style="margin-bottom: 0">Klinik Yazid Pratama</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
